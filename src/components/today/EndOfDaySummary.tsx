...
export function EndOfDaySummary({ date }: Props) {
  ...
  return (
    ...
    >
      <div className="relative gradient-calm p-5">
        <div
          aria-hidden
        ...
        <div className="relative">
          ...
          <div className="mt-4 rounded-2xl border border-border/60 bg-background/40 p-3">
            <div className="mb-2 flex items-center gap-2 text-xs uppercase tracking-wider text-muted-foreground">
              <Sun className="h-3.5 w-3.5" /> Prepare for tomorrow
              <span className="text-foreground/80 normal-case tracking-normal">· {format(tomorrow, "EEE, MMM d")}</span>
            </div>
            <ul className="grid gap-2 text-sm sm:grid-cols-2">
              <li className="flex items-start gap-2 rounded-xl bg-muted/40 px-3 py-2">
                <span className="text-base leading-none">{moon.glyph}</span>
                <div className="min-w-0">
                  <p className="text-xs font-medium">{moon.label}</p>
                  <p className="text-[11px] text-muted-foreground line-clamp-2">{moon.invitation}</p>
                </div>
              </li>
              <li className="flex items-start gap-2 rounded-xl bg-muted/40 px-3 py-2">
                <CloudSun className="mt-0.5 h-4 w-4 text-primary" />
                <div className="min-w-0">
              ...
              <li className="flex items-start gap-2 rounded-xl bg-muted/40 px-3 py-2">
                <Flame className="mt-0.5 h-4 w-4 text-accent-foreground" />
                <div className="min-w-0">
              ...
              <li className="flex items-start gap-2 rounded-xl bg-muted/40 px-3 py-2">
                <CalIcon className="mt-0.5 h-4 w-4 text-secondary-foreground" />
                <div className="min-w-0">
