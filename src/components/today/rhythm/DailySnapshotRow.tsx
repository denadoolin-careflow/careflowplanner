...
function Chip({
  icon: Icon, label, value, tone, to, onClick, title,
}: {
  ...
  const cls = "flex min-w-0 max-w-full items-center gap-2 rounded-2xl border border-border/50 bg-card/70 px-2.5 py-2 shadow-soft backdrop-blur-sm transition hover:-translate-y-0.5 hover:border-primary/40 hover:bg-card hover:shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 sm:w-auto sm:min-w-[7.5rem] sm:flex-1 sm:gap-2.5 sm:px-3 sm:py-2.5";
