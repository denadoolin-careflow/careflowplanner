...
export function PhaseCard({ to, onClick, letter, title, tagline, description, icon: Icon, tint, iconTint, delay = 0 }: Props) {
  ...
  const className = cn(
    "group relative block w-full text-left overflow-hidden rounded-3xl border border-border/60 bg-card/70 p-5 backdrop-blur-sm transition-all",
