    ...
    >
      ...
      <div className="relative flex min-h-[220px] flex-col items-end justify-between gap-5 p-5 sm:min-h-[260px] sm:p-8">
        <div className="max-w-md text-right">
          ...
          <h2 className="mt-2 font-display text-[22px] font-semibold leading-tight text-foreground sm:text-3xl">
        ...
        <div className="flex flex-wrap items-center justify-end gap-2">
          <button
            onClick={onStart}
            className={cn(
              "inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-sm font-medium text-primary-foreground shadow-sm",
          ...
          <button
            onClick={onResetAll}
            className="reset-chip inline-flex items-center gap-1.5 rounded-full px-3.5 py-2 text-sm font-medium text-foreground/80"
          >
