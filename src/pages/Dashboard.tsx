        ...
        <div className="flex flex-col items-center gap-4 p-6 text-center gradient-warm sm:flex-row sm:items-end sm:justify-between sm:gap-6 sm:p-8 sm:text-left">
          <div className="flex flex-col items-center sm:items-start">
            ...
            <Link
              ...
              className="mt-3 inline-flex flex-wrap items-center justify-center gap-1.5 rounded-full p-1 -m-1 transition-colors hover:bg-foreground/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring sm:justify-start"
            >
              <MoonPhaseBadge />
              <ElementBadge />
              <PhaseBadge />
